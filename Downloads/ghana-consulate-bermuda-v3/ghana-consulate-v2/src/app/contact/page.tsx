        ...
        <div className="lg:col-span-1 space-y-5">
          ...
          <div className="card p-5 border-l-4 border-ghana-green">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-serif font-semibold text-ghana-black mb-0.5">Address</h3>
        ...
        <div className="lg:col-span-2 space-y-8">
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              We welcome enquiries from Bermudian residents, Ghanaian nationals, and all those requiring consular
              assistance. Please contact us to schedule an appointment or to request information about our services.
              All visits are strictly by prior arrangement only.
            </p>
          </div>
          ...
          <div className="card p-6 md:p-8">
            ...
            <a
              href="mailto:info@ghanahc.bm?subject=Consulate Enquiry"
          ...
          <div className="rounded-xl border border-ghana-gold/30 overflow-hidden">
            ...
            <div className="p-5 text-sm text-gray-600 space-y-2">
              ...
              <div className="flex items-start gap-2 mt-3">
                ...
                <a href="https://ghc.org.uk" target="_blank" rel="noopener noreferrer" className="hover:text-ghana-red transition-colors">
                  ghc.org.uk
                </a>
              </div>
            </div>
          ...
          <div className="bg-ghana-green rounded-xl p-6 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-green-100 text-sm">Apply online through the official visa portal.</p>
            </div>
            <a
              href="https://dashboard.ecimsglobal.com/#/login"
              target="_blank"
              rel="noopener noreferrer"
              className="flex-shrink-0 bg-white text-ghana-green font-semibold text-sm px-5 py-2.5 rounded hover:bg-ghana-cream transition-colors"
            >
              Apply for Visa →
            </a>
          </div>
