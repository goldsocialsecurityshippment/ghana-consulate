  ...
  return (
    ...
    >
      <div className="max-w-4xl space-y-12">
        ...
        {/* Apply CTA */}
        <div className="bg-ghana-red rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h3 className="font-serif font-semibold text-white text-xl mb-1">Ready to Apply?</h3>
            <p className="text-red-100 text-sm">Apply for your Ghana visa online through the official portal.</p>
          </div>
          <a
            href="https://dashboard.ecimsglobal.com/#/login"
            target="_blank"
            rel="noopener noreferrer"
            className="flex-shrink-0 inline-flex items-center gap-2 bg-white text-ghana-red font-semibold text-sm px-6 py-3 rounded hover:bg-ghana-cream transition-colors"
          >
            Apply for Visa <ExternalLink className="w-4 h-4" />
          </a>
        </div>
