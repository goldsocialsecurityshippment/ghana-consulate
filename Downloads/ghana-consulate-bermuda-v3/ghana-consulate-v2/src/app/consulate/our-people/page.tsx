...
const nav = [
  ...
  { name: 'Meet the Team', href: '/consulate/our-people' },
  { name: 'Useful Links', href: '/consulate/useful-links' },
];

interface TeamData { people: { name: string; role: string }[] }

export const metadata = { title: 'Meet the Team | The Consulate' };
...
export default function OurPeoplePage() {
  ...
  return (
    <PageLayout
      ...
      breadcrumbs={[{ name: 'Consulate', href: '/consulate/welcome' }, { name: 'Meet the Team' }]}
      accent="green"
    >
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
        ...
        <div className="lg:col-span-3">
          ...
          <p className="text-gray-600 leading-relaxed mb-8">
            Our consulate is staffed by dedicated professionals committed to delivering high-quality
            consular services to Ghanaians and the wider Bermudian community.
          </p>
