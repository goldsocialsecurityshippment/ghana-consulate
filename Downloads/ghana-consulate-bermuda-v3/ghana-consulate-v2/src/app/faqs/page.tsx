...
const faqs = [
  ...
  },
  {
    ...
    a: 'Visa processing takes a maximum of 1 (one) day from the receipt of the passport at the Consulate. Please contact the Consulate to arrange submission of your passport and supporting documents.',
  },
  {
